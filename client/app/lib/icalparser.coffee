...
module.exports.VTodo = class VTodo extends VComponent
    ...
    extract: ->
        ...
        @model =
            ...
            stampDate: moment.tz(stampDate, VTodo.icalDTUTCFormat, 'UTC')
                                .toDate()
            description: @getTextFieldValue 'DESCRIPTION', ''
...
module.exports.VEvent = class VEvent extends VComponent
    ...
    extract: (defaultTimezone) ->
                ...
                rrule = rrule.split(';')
                    ...
                    .map (part) ->
                        ...
                        if isUntil
                            ...
                            # doesn't have a Z at the end, append it.
                            # (see #305).
        ...
        if lastModification?
            ...
            format = VEvent.icalDTUTCFormat
            lastModification = moment.tz(lastModification, format, 'UTC')
                                .toISOString()
...
class module.exports.ICalParser
